                ...
                <div className="row main-section">
                    <div className="mb-3 col-12 ps-0 pe-3 col-lg-5 d-flex flex-column justify-content-between align-items-center position-relative">
                        ...
                        <div className="star-cards w-100">
                            ...
                            <div className="calender-time-desc p-2">
                                <div><b>ராசி</b></div>
                                <div className='d-flex flex-column  flex-sm-row justify-content-evenly'>
                                    <p className='text-start fw-semibold'>{dayData.chandrastamamRasi.rashi_name}</p> <time className='d-flex gap-2'><p className='text-start'>{dayData.chandrastamamRasi.start_date}</p> | <p className='text-start'>{dayData.chandrastamamRasi.start_time}</p></time> - <time className='d-flex gap-2'><p className='text-start'>{dayData.chandrastamamRasi.end_date}</p> | <p className='text-start'>{dayData.chandrastamamRasi.end_time}</p> </time>
                                </div>
                                <hr />
                                <div><b>நட்சத்திரம்</b></div> <>{dayData.chandrastamam.map((detail, idx) => (<p key={idx}>{detail.details}</p>))}</>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-3 col-12 col-lg-7 p-4 left-con shadow-sm">
                        <div className="time-container mb-3 d-flex justify-content-between align-items-center gap-4">
                        ...
                        <div className="row gap-2">
                            <div className="col-4 col-md-4 calender-time">
                                ...
                                <div className="calender-time-desc py-2 px-3">
                                    <div className='d-flex flex-row flex-lg-column flex-xl-row align-items-center justify-content-between'><b>காலை</b><time><span>{dayData.customData.ragu_m}</span></time></div>
                                    <div className='d-flex flex-row flex-lg-column flex-xl-row align-items-center justify-content-between'><b>மாலை</b><time><span>{dayData.customData.ragu_e}</span></time></div>
                                </div>
                            </div>
                            ...
                            <div className="col calender-time">
                                ...
                                <div className="calender-time-desc py-2 px-3">
                                    <div className='d-flex flex-row flex-lg-column flex-xl-row align-items-center justify-content-between'><b>காலை</b><time><span>{dayData.customData.kuligai_m}</span></time></div>
                                    <div className='d-flex flex-row flex-lg-column flex-xl-row align-items-center justify-content-between'><b>மாலை</b><time><span>{dayData.customData.kuligai_e}</span></time></div>
                                </div>
                            </div>
                            ...
                            <div className="col calender-time">
                                ...
                                <div className="calender-time-desc py-2 px-3">
                                    <div className='d-flex flex-row flex-lg-column flex-xl-row align-items-center justify-content-between'><b>காலை</b><time><span>{dayData.customData.yama_m}</span></time> </div>
                                    <div className='d-flex flex-row flex-lg-column flex-xl-row align-items-center justify-content-between'><b>மாலை</b><time><span>{dayData.customData.yama_e}</span></time> </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row mt-3">
                            <div className="col calender-time rounded-0 border-0 border-end">
                                <h5>சூரியோதயம்</h5>
                            ...
                            <div className="col calender-time rounded-0 border-0">
                                <h5>பரிகாரம்</h5>
                                <div className="calender-time-desc">
                    ...
                    <div className="col-12 px-0">
                        <div className="sec-2 d-flex justify-content-start align-items-center h-100">
                            <div className="star-cards star-card-flex gap-2 star-cards-bg border-0 border-start border-end border-bottom rounded-0">
                                <h5 className='rounded-0'>நட்சத்திரம்</h5>
                                <p className="px-2">{dayData.dailyInfo.StarDetails}</p>
                            </div>
                            <div className="star-cards star-card-flex gap-2 star-cards-bg border-0 border-end border-bottom rounded-0">
