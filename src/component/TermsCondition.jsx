...
const TermsCondition = () => {
    return (
        <div className='container py-4'>
            ...
            />
            <p>
                By using the Makkal Naatkaati mobile application (&quot;App&quot;), you agree to abide by these Terms and Conditions.
            </p>
            <br />
            <p>
                The app provides features such as daily Panchangam, festival dates, auspicious timings (muhurthams), and special events, helping you stay connected to cultural and spiritual practices.
            </p>
            <br />
            <p>
                You agree to use the App only for lawful purposes and to ensure that your account information is accurate and confidential. You are solely responsible for all activities conducted under your account.
            </p>
            <br />
            <p>
                Any content you submit or share through the App, including event details, comments, or other materials, remains your property. However, you grant us a non-exclusive, royalty-free license to use such content for the operation and promotion of the App.
            </p>
            <br />
            <p>
                The App is provided &quot;as is,&quot; and we make no warranties regarding its availability, accuracy, or reliability. We are not responsible for any damages resulting from your use or inability to use the App.
            </p>
            <br />
            <p>
                Additionally, the App may contain links to third-party websites, and we are not liable for any content or services provided by third parties.
            </p>
            <br />
            <p>
                We reserve the right to modify, suspend, or terminate your access to the App if you violate these Terms. These Terms are governed by the laws of India.
                <br />
                For questions, please contact us at mpeoplesofficial@gmail.com.
            </p>
